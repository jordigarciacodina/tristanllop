	...
	<form id="edd_profile_editor_form" class="edd_form" action="<?php echo edd_get_current_page_url(); ?>" method="post">
		...
		<fieldset id="edd_profile_personal_fieldset">
			...
			<p id="edd_profile_first_name_wrap">
				<input placeholder="<?php _e( 'First Name', 'easy-digital-downloads' ); ?>" name="edd_first_name" id="edd_first_name" class="text edd-input" type="text" value="<?php echo esc_attr( $first_name ); ?>" />
			</p>
			...
			<p id="edd_profile_primary_email_wrap">
				...
				<?php if ( $customer->id > 0 ) : ?>
					...
					<?php if ( 1 === count( $customer->emails ) ) : ?>
						<input placeholder="<?php _e( 'Primary Email Address', 'easy-digital-downloads' ); ?>" name="edd_email" id="edd_email" class="text edd-input required" type="email" value="<?php echo esc_attr( $customer->email ); ?>" />
					<?php else: ?>
						<?php
							$emails           = array();
					...
					<?php endif; ?>
				<?php else: ?>
					<input placeholder="<?php _e( 'Primary Email Address', 'easy-digital-downloads' ); ?>" name="edd_email" id="edd_email" class="text edd-input required" type="email" value="<?php echo esc_attr( $current_user->user_email ); ?>" />
				<?php endif; ?>
		...
		<fieldset id="edd_profile_password_fieldset">
			...
			<p id="edd_profile_password_wrap">
				<input placeholder="<?php _e( 'New Password', 'easy-digital-downloads' ); ?>" name="edd_new_user_pass1" id="edd_new_user_pass1" class="password edd-input" type="password"/>
			</p>

			<p id="edd_profile_confirm_password_wrap">
				<input placeholder="<?php _e( 'Re-enter Password', 'easy-digital-downloads' ); ?>" name="edd_new_user_pass2" id="edd_new_user_pass2" class="password edd-input" type="password"/>
